...
export const PIECES = {
  ...
  R1S250: { label: 'R 1L straight 250mm', lanes: 1, l: 0.25, w: 25, h: 13.3, colors: 1, verts: [[-12.5, -6], [12.5, -6]], kind: 'straight' },
  R1REntry: { label: 'R 1L ramp entry', lanes: 1, l: 0.10, w: 10.4, h: 13.3, colors: 1, verts: [[-5.2, -6], [5.2, -6, 16]], kind: 'slope' },
  R2Ramp5: { sprite: 'R2Ramp', label: 'R 2L ramp 225mm +5', lanes: 2, l: 0.225, w: 22.8, h: 25, colors: 1, verts: [[-11.35, -11.9], [11.35, -11.9, 5]], kind: 'slope' },
  R2Ramp10: { sprite: 'R2Ramp', label: 'R 2L ramp 225mm +10', lanes: 2, l: 0.225, w: 22.8, h: 25, colors: 1, verts: [[-11.35, -11.9], [11.35, -11.9, 10]], kind: 'slope' },
  R2Ramp15: { sprite: 'R2Ramp', label: 'R 2L ramp 225mm +15', lanes: 2, l: 0.225, w: 22.8, h: 25, colors: 1, verts: [[-11.35, -11.9], [11.35, -11.9, 15]], kind: 'slope' },
  R2Ramp20: { sprite: 'R2Ramp', label: 'R 2L ramp 225mm +20', lanes: 2, l: 0.225, w: 22.8, h: 25, colors: 1, verts: [[-11.35, -11.9], [11.35, -11.9, 20]], kind: 'slope' },
  R2Ramp25: { sprite: 'R2Ramp', label: 'R 2L ramp 225mm +25', lanes: 2, l: 0.225, w: 22.8, h: 25, colors: 1, verts: [[-11.35, -11.9], [11.35, -11.9, 25]], kind: 'slope' },
  R2Ramp30: { sprite: 'R2Ramp', label: 'R 2L ramp 225mm +30', lanes: 2, l: 0.225, w: 22.8, h: 25, colors: 1, verts: [[-11.35, -11.9], [11.35, -11.9, 30]], kind: 'slope' },
  R2Ramp35: { sprite: 'R2Ramp', label: 'R 2L ramp 225mm +35', lanes: 2, l: 0.225, w: 22.8, h: 25, colors: 1, verts: [[-11.35, -11.9], [11.35, -11.9, 35]], kind: 'slope' },
  R2Ramp40: { sprite: 'R2Ramp', label: 'R 2L ramp 225mm +40', lanes: 2, l: 0.225, w: 22.8, h: 25, colors: 1, verts: [[-11.35, -11.9], [11.35, -11.9, 40]], kind: 'slope' },
  R2Ramp45: { sprite: 'R2Ramp', label: 'R 2L ramp 225mm +45', lanes: 2, l: 0.225, w: 22.8, h: 25, colors: 1, verts: [[-11.35, -11.9], [11.35, -11.9, 45]], kind: 'slope' },
