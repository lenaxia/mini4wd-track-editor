...
export const PIECES = {
  ...
  R2Ramp10: { sprite: 'R2Ramp.svg', label: 'R 2L ramp 225mm +10', lanes: 2, l: 0.225, w: 22.8, h: 25, colors: 1, verts: [[-11.35, 0], [11.35, 0, 10]], kind: 'slope' },
  R2Ramp15: { sprite: 'R2Ramp.svg', label: 'R 2L ramp 225mm +15', lanes: 2, l: 0.225, w: 22.8, h: 25, colors: 1, verts: [[-11.35, 0], [11.35, 0, 15]], kind: 'slope' },
  R2Ramp20: { sprite: 'R2Ramp.svg', label: 'R 2L ramp 225mm +20', lanes: 2, l: 0.225, w: 22.8, h: 25, colors: 1, verts: [[-11.35, 0], [11.35, 0, 20]], kind: 'slope' },
  R2Ramp25: { sprite: 'R2Ramp.svg', label: 'R 2L ramp 225mm +25', lanes: 2, l: 0.225, w: 22.8, h: 25, colors: 1, verts: [[-11.35, 0], [11.35, 0, 25]], kind: 'slope' },
  R2Ramp30: { sprite: 'R2Ramp.svg', label: 'R 2L ramp 225mm +30', lanes: 2, l: 0.225, w: 22.8, h: 25, colors: 1, verts: [[-11.35, 0], [11.35, 0, 30]], kind: 'slope' },
  R2Ramp35: { sprite: 'R2Ramp.svg', label: 'R 2L ramp 225mm +35', lanes: 2, l: 0.225, w: 22.8, h: 25, colors: 1, verts: [[-11.35, 0], [11.35, 0, 35]], kind: 'slope' },
  R2Ramp40: { sprite: 'R2Ramp.svg', label: 'R 2L ramp 225mm +40', lanes: 2, l: 0.225, w: 22.8, h: 25, colors: 1, verts: [[-11.35, 0], [11.35, 0, 40]], kind: 'slope' },
  R2Ramp45: { sprite: 'R2Ramp.svg', label: 'R 2L ramp 225mm +45', lanes: 2, l: 0.225, w: 22.8, h: 25, colors: 1, verts: [[-11.35, 0], [11.35, 0, 45]], kind: 'slope' },
